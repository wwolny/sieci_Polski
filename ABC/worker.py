class Worker:
    ...
    def search_for_new_solution(self):
        ...
        current_slice = 0
        transponder = 3
        while len(self.current_solution.constraint_1_not_met) > 0 and iteration > 0 and current_slice < self.network.MaxFreqSlices or transponder < 0:
            ...
            for path in chosen_paths:
                ...
                self.current_solution.add_transponder(path_id, self.network.transponders[transponder], current_slice, self.network.slices_bands.get(current_slice))
